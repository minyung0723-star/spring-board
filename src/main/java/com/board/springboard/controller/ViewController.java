...
public class ViewController {
     ...
     *              write.jsp 의 form에서 전송된 게시물 데이터 (title, writer, content)
     ...
     * 속성 종류 : <br>
     * Value 는 다른 속성이 없으면 기본으로 설정되는 속성이므로 작성하지 않아도 되는 값 <br>
     ...
     * @RequestParam(required = required = false, value = "imageFile") MultipartFile imageFile)
